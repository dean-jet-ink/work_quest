...
export const Top: VFC = memo(() => {
  ...
  const [myProfile] = useFetchUser(loginUserId as number);
  const {
    initialValues,
    incompleteWorks,
    completeWorks,
  ...
  const { file, fileLoad } = useFile(myProfile.picture);
  ...
  return (
    <PrimaryLayout onClick={onOpenProfile} src={myProfile.picture}>
      <PrimaryWrapper>
        <Flex
          py={{ base: 3, md: 6 }}
          px={{ base: 2 }}
